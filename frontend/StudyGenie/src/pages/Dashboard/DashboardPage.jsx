            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className='flex items-center justify-between'>
                  ...
                  <div className={`w-11 h-11 rounded-xl ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                    <stat.icon className='w-5 h-5 text-white' strokeWidth={2} />
                  </div>
                </div>
                <div className='text-3xl font-semibold text-slate-900 tracking-light mt-4'>
                  {stat.value}
                </div>
              </div>
            ))}
                ...
                {[
                  ...
                  .map((activity, index) => (
                    <div
                      ...
                      className="group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200"
                    >
