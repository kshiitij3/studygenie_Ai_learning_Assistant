...
import {FileText,Trash2, BookOpen, BrainCircuit, Clock, Divide} from 'lucide-react';
import moment from 'moment';
//Helper functionto format file size
      ...
      onClick={handleNavigate}>
          ...
          <div>
            <div className='flex items-start justify-between gap-3 mb-4'>
              ...
              className='opacity-0 group-hover:opacity-100 w-8 h-8 flex items-center justify-center text-slate-400 hover:text-red-500 rounded-lg transition-all duration-200'
              >
