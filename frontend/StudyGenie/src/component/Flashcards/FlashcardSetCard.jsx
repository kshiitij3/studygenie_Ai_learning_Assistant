...
const FlashcardSetCard = ({ flashcardSet }) => {
 ...
 const progressPercentage = totalCards > 0 ? Math.round((reviewedCount / totalCards) * 100) : 0;
  ...
  return <div
     className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 transition-all duration-200 cursor-pointer hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between'
