  ...
  return(
    ...
    <div className='text-neutral-700'>
      ...
      components={{
        ...
        blockquote: (props) => <blockquote className="border-l-4 border-neutral-300 pl-4 italic text-neutral-600 my-4" {...props}/>,
        ...
        pre:(props)=> <pre className='bg-neutral text-white p-3 rounded-md overflow-x-auto font-mono text-sm my-4' {...props}/>
      }}
      >
        {content}
      </ReactMarkdown>
